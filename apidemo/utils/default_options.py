def define_default_arguments(parser):
    ...
    parser.add_argument('--json-root', type=str, default="", help="")
    ...
    parser.add_argument('--weak-corpus', choices=['scenario','voa', "gigaword", "ace", "ere", "none"], default='ace', help="")
    parser.add_argument('--weak-annotation', choices=['kw', "label", "cluster"], default='cluster', help="")
    ...
    parser.add_argument('--model-name', type=str, default="roberta-large", help="path to save checkpoints")
...
def define_default_arguments_for_weak_supervision(parser):
    parser.add_argument("--train-file", "-tr", type=str, default="/shared/nas/data/m1/pengfei4/research/event-weak-supervision/data/api_test/train.json")
    parser.add_argument("--dev-file", "-de", type=str, default="/shared/nas/data/m1/pengfei4/research/event-weak-supervision/data/api_test/dev.json")
    parser.add_argument("--preprocess_func", "-f", type=str, default="")
    parser.add_argument("--corpus-jsonl", "-cj", type=str, default="/shared/nas/data/m1/pengfei4/research/event-weak-supervision/data/api_test/corpus.jsonl")
    parser.add_argument("--example-json", "-ej", type=str, default="/shared/nas/data/m1/pengfei4/research/event-weak-supervision/data/api_test/examples.json")
    parser.add_argument("--evaluation-json", "-eval", type=str, default="")
    parser.add_argument("--threshold", "-th", type=float, default=-1)
    parser.add_argument("--label-json", "-lj", type=str, default="/shared/nas/data/m1/pengfei4/research/event-weak-supervision/data/api_test/label_info.json")
    parser.add_argument("--model-name", "-mn", type=str, default="bert-large-cased")
    parser.add_argument("--encoding-save-dir", "-ed", type=str, default="/shared/nas/data/m1/pengfei4/research/event-weak-supervision/data/api_test/data")
    parser.add_argument("--output-save-dir", "-kd", type=str, default="/shared/nas/data/m1/pengfei4/research/event-weak-supervision/data/api_test/data")
    parser.add_argument("--no-evaluate", "-n", action="store_true")
